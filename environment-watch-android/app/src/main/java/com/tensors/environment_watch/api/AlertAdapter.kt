...
val species = mutableListOf(
    ...
    Species("Rusty Blackbird", "E. carolinus", "rusty_blackbird", "Threatened", "A North American medium-sized blackbird. They have a pointed bill, yellowish eyes, and their feathers are black with a faint green and purple gloss.", "Rusty Blackbird prefers wet forested areas, breeding in the boreal forest and muskeg across northern Canada, and migrating southeast to the United States during winter. Formerly abundant, the rusty blackbird has become one of the most declined bird species in America."),
